...
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
          content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, manimum-scale=1.0">
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a href="<?php echo base_url('index.php/Admin/AddPost'); ?>">Add Movie</a></li>
      <li><a href="<?php echo base_url('index.php/Admin/films'); ?>">view Movies</a></li>
